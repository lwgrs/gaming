---
permalink: "/mario-vs-donkey-kong-GBA/"
...
Mario vs Donkey Kong is the 2004 follow-up to the popular 1994 Game Boy title, [Donkey Kong](/2023/07/15/donkey-kong-game-boy-1994/). It was released for the Game Boy Advance handheld, and apparently started its life as some sort of weird [GameCube / GBA hybrid](https://en.wikipedia.org/wiki/Mario_vs._Donkey_Kong):
...
This sounds really cool! And is probably something that eventually became real in the [Super Mario Maker series](https://en.wikipedia.org/wiki/Super_Mario_Maker); apparently the level creator exists in the code on the Mario vs DK cart, and can be accessed with [modification](https://tcrf.net/Mario_vs._Donkey_Kong). I’m not ever going to try that, but kudos to those who have figured it out.

Going back to Mario vs Donkey Kong, this game pulls many elements from the 10-year-old *Donkey Kong* title for the Game Boy, and adds quite a few more to try to make the game a little more challenging. Plus, the graphics are massively upgraded. Mario has a lot more definition to him – in the original game, Mario only looked [vaguely like Mario](https://venturebeat.com/games/the-retrobeat-donkey-kong-94-for-the-game-boy-is-nintendos-forgotten-masterpiece/). In MvsDK, [Mario looks like the one we’re familiar with on the handheld platform](https://wizarddojo.com/2019/07/16/mario-vs-donkey-kong-review/). The levels are colourful and some of the puzzles rely on this use of colour to activate various switches in specific order. In many ways some of the elements from 1994 are made easier to identify because things have different shades.
...
###### [Reply by Email](mailto:srgower+gaming@gmail.com?subject=Re:%20Mario%20vs%20Donkey%20Kong) or contact me via [Mastodon](https://ottawa.place/@srgower).
